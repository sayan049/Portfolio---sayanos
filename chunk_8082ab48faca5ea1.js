(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
        ...
        get: function () {
          return function e(t, r, a, u, o, i, c) {
            ...
            for (let f in u[1]) {
              ...
              let g = r.parallelRoutes.get(f);
              (g ? g.set(h, s) : r.parallelRoutes.set(f, new Map([[h, s]])),
      ...
      Object.defineProperty(r, "applyRouterStatePatchToTree", {
        ...
        get: function () {
          return function e(t, r, n, i) {
            ...
            if (2 === t.length) c = o(s[g], n);
            else if (
              null === (c = e((0, l.getNextFlightSegmentPath)(t), s[g], n, i))
            )
              return null;
            let _ = [t[0], { ...s, [g]: c }, d, p];
            return (
  ...
  (e, t, r) => {
    ...
    function L(e) {
      ...
      if (j.mpaNavigation) {
        if (S.pendingMpaPath !== d) {
          ...
          (j.pendingPush ? e.assign(d) : e.replace(d), (S.pendingMpaPath = d));
        }
      ...
      let { cache: M, tree: A, nextUrl: N, focusAndScrollRef: L } = c,
        I = (0, u.useMemo)(() => (0, g.findHeadInCache)(M, A[1]), [M, A]),
      ...
      let K = (0, a.jsxs)(y.RedirectBoundary, {
        children: [
          t,
          (0, a.jsx)(w.RootLayoutBoundary, { children: M.rsc }),
    ...
    function I(e) {
      ...
      return (0, a.jsx)(T.default, { errorComponent: j.default, children: l });
    }
    let D = new Set(),
      F = new Set();
    function H() {
  ...
  (e, t, r) => {
    ...
    function c(e, t, r, u, o, c, d, p, h) {
      return (function e(t, r, u, o, c, d, p, h, y, g, _) {
        let v = u[1],
          R = o[1],
          b = null !== d ? d[2] : null;
        c || (!0 === o[4] && (c = !0));
            ...
            (u =
              S === n.DEFAULT_SEGMENT_KEY
                ? void 0 !== s
                  ...
                  : f(t, s, o, N, c, void 0 !== w ? w : null, p, h, M, _)
        ...
        return {
          route: s(o, E),
          node: w,
          dynamicRequestTree: T ? s(o, j) : null,
          children: O,
        };
      })(e, t, r, u, !1, o, c, d, p, [], h);
    }
      ...
      return !l && (void 0 === t || (0, u.isNavigatingToNewRootLayout)(t, r))
        ...
        : (function e(t, r, n, l, u, i, c, f) {
            ...
            if (void 0 !== n && n.navigatedAt + o.DYNAMIC_STALETIME_MS > t)
              ((p = n.rsc), (h = n.loading), (y = n.head), (g = n.navigatedAt));
          ...
          node: (function e(t, r, n, l, u, o, i) {
            ...
            for (let r in c) {
              let n = c[r],
                ...
                g = e(t, n, void 0 === d ? null : d, l, u, h, i),
                _ = new Map();
              (_.set(y, g), s.set(r, _));
            }
            let d = 0 === s.size;
  ...
  (e, t, r) => {
    ...
    let n = e.r(13258),
      ...
      c = e.r(47442),
      f = e.r(54069);
    function s(e, t, r, s, p) {
      let h,
        y = t.tree,
        g = t.cache,
        _ = (0, u.createHrefFromUrl)(s),
        v = [];
      ...
      for (let t of r) {
        if (
          ...
          continue;
        let r = t.tree;
        r = d(r, Object.fromEntries(s.searchParams));
        let { seedData: u, isRootRender: c, pathToSegment: p } = t,
          R = ["", ...p];
        r = d(r, Object.fromEntries(s.searchParams));
        let b = (0, a.applyRouterStatePatchToTree)(R, y, r, _),
          P = (0, l.createEmptyCacheNode)();
        if (c && u) {
          let t = u[1];
          ((P.loading = u[3]),
            (P.rsc = t),
          ...
          ((P.rsc = g.rsc),
            (P.prefetchRsc = g.prefetchRsc),
            (P.loading = g.loading),
            (P.parallelRoutes = new Map(g.parallelRoutes)),
            (0, i.fillCacheWithNewSubTreeDataButOnlyLoading)(e, P, g, t));
        for (let e of (b && ((y = b), (g = P), (h = !0)),
        (0, f.generateSegmentsFromPatch)(r))) {
    ...
    function d(e, t) {
      ...
      let u = {};
      for (let [e, r] of Object.entries(l)) u[e] = d(r, t);
      return [r, u, ...a];
    }
    ("function" == typeof r.default ||
      ("object" == typeof r.default && null !== r.default)) &&
        ...
        navigateReducer: function () {
          return function e(t, r) {
            ...
            return (
              ...
              N.then(
                (d) => {
                  let { flightData: g, canonicalUrl: m, postponed: E } = d,
                    T = Date.now(),
                    N = !1;
                  if (
                    (A.lastUsedTime || ((A.lastUsedTime = T), (N = !0)),
                    A.aliased)
                  ) {
                    let n = new URL(P.href);
                    m && (n.pathname = m.pathname);
                    let l = (0, v.handleAliasedPrefetchEntry)(T, t, g, n, j);
                    return !1 === l ? e(t, { ...r, allowAliasing: !1 }) : l;
                  }
                  if ("string" == typeof g) return R(t, j, g, M);
                  let x = m ? (0, l.createHrefFromUrl)(m) : S;
                  if (
                    w &&
                  ...
                  for (let e of g) {
                    let {
                      ...
                      v = e.tree,
                      m = ["", ...r],
                      O = (0, u.applyRouterStatePatchToTree)(m, U, v, S);
                    if (
                      (null === O &&
                        (O = (0, u.applyRouterStatePatchToTree)(m, C, v, S)),
                      null !== O)
                    ) {
                      if (l && g && E) {
                        ...
                        if (null !== e) {
                          if (null === e.route) return R(t, j, S, M);
                          O = e.route;
                          let r = e.node;
                          null !== r && (j.cache = r);
                        ...
                        for (let t of (A.status !==
                          ...
                          ? (l = (0, s.applyFlightData)(T, L, n, e, A))
                          : ((l = (function (e, t, r, n) {
                              let l = !1;
  ...
  (e, t, r) => {
    ...
    async function S(e, t, r) {
      let i,
        ...
        g = (0, j.extractInfoFromServerReferenceId)(p),
        _ = "use-cache" === g.type ? (0, j.omitUnusedArgs)(h, g) : h,
        v = await (0, o.encodeReply)(_, { temporaryReferences: y }),
      ...
      let T = !!R.headers.get(a.NEXT_IS_PRERENDER_HEADER);
      try {
      ...
      if (C) {
        ...
        ((s = S ? void 0 : e.a), (d = (0, b.normalizeFlightData)(e.f)));
        ...
        async (c) => {
          ...
          if (
            (w &&
              ...
              (l.canonicalUrl = _ = (0, f.createHrefFromUrl)(w, !1))),
            !j)
          )
            return (r(b), w)
          ...
          if ("string" == typeof j)
            return (
              r(b),
              (0, s.handleExternalUrl)(e, l, j, e.pushRef.pendingPush)
            );
              ...
              ? (C ||
                ...
                n(
                  (0, P.getRedirectError)(
                    (0, T.hasBasePath)(_) ? (0, O.removeBasePath)(_) : _,
